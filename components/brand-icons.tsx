...
/**
 * lucide-react v1 removed all brand marks (trademark reasons), so GitHub and
 * LinkedIn live here. Same call signature as a lucide icon — size comes from
 * the `h-*`/`w-*` classes, colour from `currentColor`.
 */
