...
/**
 * lucide-react v1 removed all brand marks (trademark reasons), so GitHub,
 * LinkedIn, Upwork and Fiverr live here. Same call signature as a lucide icon —
 * size comes from the `h-*`/`w-*` classes, colour from `currentColor`. The
 * Upwork and Fiverr paths are from simple-icons (CC0); Kwork has no mark there,
 * so its links use lucide's `Briefcase`.
 */
